...
public class ExampleInjectors
{
    ...
    // this dependency will be ignored if the mixin or mod was not found (it is an optional dependency)
    ...
    // will not apply if that mod or mixin was not found
    ...
    public void Test /* mixin name */ (string[] args /* inject specifically into Program.Main(string[]) */)
    {
